          ...
          {loading ? (
            ...
            <>
              ...
              <div className="grid grid-cols-2 xl:grid-cols-4 gap-4">
                {[
                  { label: "Total Penjualan", val: fmt(data.summary.totalPenjualan), icon: TrendingUp, color: "green" },
                  { label: "Total Transaksi", val: data.summary.totalTransaksi, icon: ShoppingBag, color: "green" },
                  { label: "Unit Terjual", val: data.summary.totalUnit, icon: Package, color: "amber" },
                  { label: "Nilai Stok", val: fmt(data.summary.totalNilaiStok), icon: Layers, color: "red" },
